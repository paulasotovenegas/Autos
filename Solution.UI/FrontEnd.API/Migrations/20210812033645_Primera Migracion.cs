    ...
    public partial class PrimeraMigracion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TiposAutos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TerminacionPlaca = table.Column<string>(nullable: true),
                    Cpuertas = table.Column<int>(nullable: false),
                    ...
                    IdTransmision = table.Column<int>(nullable: false),
                    IdEstado = table.Column<int>(nullable: false),
                    IdCombustible = table.Column<int>(nullable: false),
                    CombustibleId = table.Column<int>(nullable: true),
                    EstadoId = table.Column<int>(nullable: true),
                    MarcaId = table.Column<int>(nullable: true),
                    ModeloId = table.Column<int>(nullable: true),
                    TipoId = table.Column<int>(nullable: true),
                    TransmisionId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Autos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Autos_Combustible_CombustibleId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Autos_TiposAutos_TipoId",
                        column: x => x.TipoId,
                        principalTable: "TiposAutos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
